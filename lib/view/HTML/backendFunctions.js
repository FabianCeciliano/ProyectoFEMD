...
//////////////////////////////////////////////////////////////////// 
////////////////////////////////////////////////////////////////////
//         FUNCIONES QUE ANESTE ESTABAN EN EL HTML                // 
////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////// 
...
function BFormularioGrupo() {
    ...
    //document.getElementById("acepAsigGrupo").disabled = true;
    limpiarCoordinacion();
}
    ...
    $.ajax({
        ...
        success: function (data) {
            if (data.status == 1) {
                ...
                alert("No hay sufucientes datos /n para esta operacion");
            }
        }
    })
}
