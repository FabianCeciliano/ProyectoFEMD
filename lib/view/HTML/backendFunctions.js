    ...
    $.ajax({
        ...
        success: function (data) {
            if(data.status == 0){//No hay nada en la base, por lo que debe bloquear los botones
                disableMenu(true);
                BMovimiento();
                error("Debe crear un movimiento");
            }
        }
    })
}
...
function structConfirm() {
    ...
    if (zonaName != "" & list.length > 0 & listId.length > 0) {
        ...
        error('Recuerde ingresar la zona y al menos una rama')
    }
...
function cambiarMovimiento(){
    ...
    if(idMovement!=""){
        $.ajax({
            ...
            success: function (data) {
                if(data.status==1){
                    msg("Ha cambiado al movimiento:\n"+document.getElementById("changeMovementList").value);
                }else{
                    error("Ha habido un problema con el cambio de movimiento");
                }
            }
        })
    }else{
        error('Error en el id del movimiento');
    }
    ...
    $.ajax({
        ...
        success: function (data) {
            if(data.status==1){
                ...
                error("No hay movimientos creados");
            }
        }
    })
}
    ...
    $.ajax({
        ...
        success: function (data) {
            if (data.status == 1) {
                ...
                error('Aun no hay zonas disponibles')
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data.status == 1) {
                    ...
                    error('Verifique que el ID de grupo sea distinto');
                }
            }
        })
    } else {
        error('Ingresar todos los datos')
    }
}
...
function asigAsignar() {
    ...
    if (idCoach != "" & idGrupo != "") {
        $.ajax({
            ...
            success: function (data) {
                if (data.status == 1) {
                    msg("Coach asignado a rama");
                    BAsignarMonior();
                } else {
                    error('Error al asignar Coach');
                }
            }
        })
    } else {
        error('Recuerde ingresar el ID del Coach y del Grupo');
    }
}
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data.status == 1) {
                    ...
                    error("No se pueden asignar jefes en esta zona");
                }
            }
        })
    } else {
        error("Ingrese el nombre y id de Zona");
    }
}
...
function aceptarAsignacionZona() {
    ...
    if (nombreZona != "") {
        $.ajax({
            ...
            success: function (data) {
                if (data.status == 2) {
                    error("No puede asignar jefe!")
                } else if (data.status == 1) {
                    msg("Jefe(s) asignado(s)!")
                } else {
                    error("No se pudo agregar el jefe!")
                }
            }
        })
    } else {
        error("Ingrese al menos 1 nombre y un id para asignar");
    }
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data.status == 1) { //listBranchChief listGroupChief
                    ...
                    error("No se pueden asignar jefes en esta rama");
                }
            }
        })
    } else {
        error("Ingrese el nombre de zona y id de Rama");
    }
}
    ...
    $.ajax({
        ...
        success: function (data) {
            if (data.status == 1) {
                ...
                error("No hay sufucientes datos \n para esta operacion");
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data.status == 1) {
                    ...
                    error("No se encontro participacion");
                }
            }
        })
    } else {
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data.status == 1) {
                    ...
                    showUser();
                    error("Seleccione la estructura donde se eliminara el usuario");
                }
            }
        })
...
function modificarUsuario() {
    ...
    if (id != "" & nombre != "" & celular != "" & mail != "" & direccion != "") {
        ...
        error("Ingrese al menos un campo");
    }
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data.status == 1) {
                    ...
                    document.getElementById("movimientoPais").value = "";
                    document.getElementById("movimientoTelefono").value = "";
                    error("El movimiento ya fue creado");
                }
            }
        })
    } else {
    ...
    $.ajax({
        ...
        success: function (data) {
            if (data.status == 1) {
                ...
                error("No hay sufucientes datos para esta operacion");
...
function agregarRama() {
    if (document.getElementById("structRName").value != "" & document.getElementById("structRId").value != "") {
        ...
        error('Ingrese una rama y su id');
    }
}
    ...
    $.ajax({
        ...
        success: function (data) {
            if (data.status == 1) {
                ...
                error('No hay ramas en esta zona');
            }
        }
    })
}
