...
function agregarUsuario(){
    ...
    if(id!="" & nombre!="" & celular!="" & mail!="" & direccion!=""){
        $.ajax({ 
            ...
            dataType: 'json',
            cache: false,
            data : JSON.stringify({id:id,name:nombre,celular:celular,mail:mail,direccion:direccion}),
            success: function(data){
                if(data.status==1){
...
function moverUsuario(){
    ...
    if(id!="" & nombre!="" & idProcedencia!="" & idDestino!=""){
        $.ajax({ 
            ...
            dataType: 'json',
            cache: false,
            data : JSON.stringify({id:id,name:nombre,idProcedencia:idProcedencia,idDestino:idDestino}),
            success: function(data){
                if(data.status==1){
