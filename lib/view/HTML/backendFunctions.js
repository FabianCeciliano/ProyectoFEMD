...
function myFunctionMisGrupos(pData, pArray) {
    ...
    var page = document.getElementById("scrollArea");
    page.appendChild(btn);
    var mybr = document.createElement('br');
    page.appendChild(mybr);
    ...
    selectList.onchange = function () {
        ...
        console.log("--------------------------");
        document.getElementById("msgTextGENE").innerHTML = "aa";
        document.getElementById("msgGEN").style.display = "block";
        document.getElementById("msgGENE").style.display = "block";
        //Create and append the options
        for (var i = 0; i < array.length; i++) {
            var option = document.createElement("option");
            if (x == array[i]) {
                document.getElementById("msgTextGENE").innerHTML = x;
            }
...
// INBOX 
function myFunctionInbox (pAsunto, pMensaje, pTipo, pDate) {
    var btn = document.createElement("BUTTON");
    btn.innerHTML =  pAsunto + "\n" + pTipo + "\n" + pDate +"\n";
    btn.style.width = "1040px";
    btn.style.height = "100px";
...
function BAporte() {
    ...
    var page = document.getElementById("scrollAreaAporte");
    for( let i = 0; page.childNodes.length ; i++){
...
function enviarNoticia(){
    var cuerpoNoticia = document.getElementById("").value;
    var asuntoNoticia = document.getElementById("").value;
    var rutaNoticia = document.getElementById("").value;
    var nivelNoticia = document.getElementById("").value;

    if(cuerpo != "" && asunto != "" && ruta != ""){
        $.ajax({
            url: '/nuevaNoticia',
            type: 'POST',
            contentType: 'application/json; charset=utf-8',
