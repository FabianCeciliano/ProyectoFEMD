...
function showEst() {
    ...
    document.getElementById("msgData").innerHTML = str.fontcolor("blue");
    document.getElementById("msgData").innerHTML = document.getElementById("msgData").innerHTML + str.fontcolor("orange");
