...
////////////////////////////////////////////////////////////////////
function modificarUsuario() {
    var titulo = document.getElementById("updateUserId").value;
    var tipo = document.getElementById("updateUserName").value;
    var descripcion = document.getElementById("updateUserCelular").value;
    ...
    if (titulo != "" & tipo != "" & descripcion != "") {
        $.ajax({
            ...
            dataType: 'json',
            cache: false,
            data: JSON.stringify({ titulo: titulo, tipo: tipo, descripcion: descripcion}),
            success: function (data) {
                if (data.status == 1) {
